...
|----------|----------|:--------:|:--:|:---:|:------:|
| **Slit-lamp** | EfficientNet-B0 | 1,309 | **0.900** | **0.988** | 93.1% |
| B-scan OCT | ResNet-18 (Kermany PT) | 10,739 | 0.900 | 1.000 | 100.0% |
| OCTA | ResNet-18 (ImageNet PT) | 525 | 0.780 | 0.910 | 82.1% |
| CFP | EfficientNet-B0 | 870 | 0.783 | 1.000 | 100.0% |

**Slit-lamp modeli, en dengeli performansı sergileyen modalitedir.** Hem precision hem recall yüksek, AUC neredeyse mükemmel (0.988). Diğer modalitelerde ya recall çok yüksek ama precision düşük (CFP, B-scan), ya da tam tersi (OCTA).
